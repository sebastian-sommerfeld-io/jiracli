...
|`src/main/utils` |Utility modules which are used from other scripts (e.g. link:https://github.com/spf13/cobra-cli[cobra-cli] or link:xref:AUTO-GENERATED:bash-docs/src/main/bash-modules/go-wrapper-sh.adoc[the wrapper script to run Go in Docker]).
|===
